...
if (!html.includes('app.js?v=86') || !appSource.includes("sw.js?v=86") || !swSource.includes("cache: 'reload'")) failures.push('Versioned app assets or forced service-worker refresh are missing');
