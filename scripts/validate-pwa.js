...
if (!html.includes('app.js?v=80') || !appSource.includes("sw.js?v=80") || !swSource.includes("cache: 'reload'")) failures.push('Versioned app assets or forced service-worker refresh are missing');
